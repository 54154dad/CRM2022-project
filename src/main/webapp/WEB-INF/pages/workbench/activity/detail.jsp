...
<script type="text/javascript">
	...
	//	给保存按钮绑定单击事件
			...
			$.ajax({
				...
				success:function(data){
					if (data.code == "1"){
						...
						htmlStr+="<a class=\"myHref\" name=\"editA\" remarkId=\""+data.retData.id+"\" href=\"javascript:void(0);\" onclick=\"modalShow()\"><span class=\"glyphicon glyphicon-edit\" style=\"font-size: 20px; color: #E6E6E6;\"></span></a>";
						htmlStr+="&nbsp;&nbsp;&nbsp;&nbsp;";
		...
		$("#remarkDivList").on("click","a[name='deleteA']",function () {
			...
			//发送请求
			$.ajax({
				url:'workbench/activity/deleteRemarkByIds.do',
				data:{
					id:id
				},
				type:'post',
		...
		$("#updateRemarkBtn").click(function () {
			...
			//发送请求
			$.ajax({
				url:'workbench/activity/updateRemarkActivity.do',
				data:{
					id:id,
					noteContent:noteContent
				},
		...
		<div id="div_${remark.id}" class="remarkDiv" style="height: 60px;">
			...
			<div style="position: relative; top: -40px; left: 40px;" >
				...
				<div style="position: relative; left: 500px; top: -30px; height: 30px; width: 100px; display: none;">
					<a class="myHref" name="editA" remarkId="${remark.id}" href="javascript:void(0);" onclick="modalShow()"><span class="glyphicon glyphicon-edit" style="font-size: 20px; color: #E6E6E6;"></span></a>
					&nbsp;&nbsp;&nbsp;&nbsp;
